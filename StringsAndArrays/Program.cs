namespace StringsAndArrays
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("The first character of the string is:" + firstCharacter);
            Console.WriteLine("The last character of the string is:" + lastCharacter);
            ...
            if (containsWorld) 
            {
                ...
                Console.Writeline("The index of the word is: " + index);
                    }
            ...
            string result = string.Join(" ", numbers);
                Console.WriteLine("The numbers in the array are: " + result);
            ...
            int thirdItem = numbers[2];
                Console.Writeline("The third item in the number array is: " + thirdItem);
            ...
            //     and adding each name to the names string array in the given order.
            ...
            if (position != -1)
            {
                Console.WriteLine($"The name '{searchName}' was found at the position {position}.");
            }
            else
            {
                Console.WriteLine($"The name '{searchName}' was not found.");
            }
            ...
            // 1.2 Try to get each word from the helloWorld variable and adding the values to
            //     the created words string array
            string helloWorld = "Hello World";
            words = helloWorld.Split(' ');
            // 1.3 Output the values of the words array
            Console.WriteLine("Words array output:");
